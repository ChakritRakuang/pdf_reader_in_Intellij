...
SVGGraphics = (function SVGGraphicsClosure() {
  ...
  SVGGraphics.prototype = {
    ...
    setTextMatrix: function SVGGraphics_setTextMatrix(a, b, c, d, e, f) {
      ...
      current.xcoords = [];
      current.tspan = DOMSVGFactory.createElement('svg:tspan');
      current.tspan.setAttributeNS(null, 'font-family', current.fontFamily);
      current.tspan.setAttributeNS(null, 'font-size',
                                   pf(current.fontSize) + 'px');
      current.tspan.setAttributeNS(null, 'y', pf(-current.y));

      current.txtElement = DOMSVGFactory.createElement('svg:text');
    ...
    beginText: function SVGGraphics_beginText() {
      ...
      this.current.tspan = DOMSVGFactory.createElement('svg:tspan');
      this.current.txtElement = DOMSVGFactory.createElement('svg:text');
      this.current.txtgrp = DOMSVGFactory.createElement('svg:g');
    ...
    addFontStyle: function SVGGraphics_addFontStyle(fontObj) {
      if (!this.cssStyle) {
        this.cssStyle = DOMSVGFactory.createElement('svg:style');
    ...
    constructPath: function SVGGraphics_constructPath(ops, args) {
      ...
      current.path = DOMSVGFactory.createElement('svg:path');
      var d = [];
    ...
    endPath: function SVGGraphics_endPath() {
      ...
      clipCount++;
      var clipPath = DOMSVGFactory.createElement('svg:clipPath');
    ...
    paintSolidColorImageMask:
      ...
      var current = this.current;
      var rect = DOMSVGFactory.createElement('svg:rect');
    ...
    paintJpegXObject: function SVGGraphics_paintJpegXObject(objId, w, h) {
      ...
      var imgEl = DOMSVGFactory.createElement('svg:image');
    ...
    paintInlineImageXObject:
      ...
      var cliprect = DOMSVGFactory.createElement('svg:rect');
    ...
    paintImageMaskXObject:
      ...
      var mask = DOMSVGFactory.createElement('svg:mask');
    ...
    _initialize(viewport) {
      let svg = DOMSVGFactory.create(viewport.width, viewport.height);

      // Create the definitions element.
      let definitions = DOMSVGFactory.createElement('svg:defs');
      svg.appendChild(definitions);
      this.defs = definitions;

      // Create the root group element, which acts a container for all other
      // groups and applies the viewport transform.
      let rootGroup = DOMSVGFactory.createElement('svg:g');
    ...
    _ensureClipGroup: function SVGGraphics_ensureClipGroup() {
      if (!this.current.clipGroup) {
        var clipGroup = DOMSVGFactory.createElement('svg:g');
    ...
    _ensureTransformGroup: function SVGGraphics_ensureTransformGroup() {
      if (!this.tgrp) {
        this.tgrp = DOMSVGFactory.createElement('svg:g');
