...
var CachedCanvases = (function CachedCanvasesClosure() {
  ...
  CachedCanvases.prototype = {
    getCanvas: function CachedCanvases_getCanvas(id, width, height,
        ...
        DOMCanvasFactory.reset(canvasEntry, width, height);
        // reset canvas transform for emulated mozCurrentTransform, if needed
        canvasEntry.context.setTransform(1, 0, 0, 1, 0, 0);
      } else {
        canvasEntry = DOMCanvasFactory.create(width, height);
    ...
    clear() {
      for (var id in this.cache) {
        ...
        DOMCanvasFactory.destroy(canvasEntry);
...
var CanvasGraphics = (function CanvasGraphicsClosure() {
  ...
  CanvasGraphics.prototype = {
    ...
    get isFontSubpixelAAEnabled() {
      ...
      var ctx = DOMCanvasFactory.create(10, 10).context;
      ctx.scale(1.5, 1);
      ctx.fillText('I', 0, 10);
    ...
    paintJpegXObject: function CanvasGraphics_paintJpegXObject(objId, w, h) {
        let domImage = this.objs.get(objId);
        if (!domImage) {
    ...
    paintImageXObject: function CanvasGraphics_paintImageXObject(objId) {
        let imgData = this.objs.get(objId);
        if (!imgData) {
        warn('Dependent image isn\'t ready yet');
        return;
      }
